...
class GANLoss(nn.Module):
    ...
    def __init__(self, d_last_layer_size):
        ...
        #self.loss = nn.MSELoss() #nn.L1Loss(reduction='mean')
        # Make a shape
    ...
    def forward(self, d_last_layer, is_d_input_real):
        ...
        # Compute the loss
        wgan_loss = torch.mean(d_last_layer) - torch.mean(label_tensor)
        return wgan_loss #self.loss(d_last_layer, label_tensor)
